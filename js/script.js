const commandsData = {
  funRandom: {
    ...
    commands: [
      ...
      { name: "/animal [fox], [cat], [dog]", description: "Obrázky zvieratiek", permission: "All" },
  ...
  interakcie: {
    ...
    commands: [
      ...
      { name: "/feed", description: "Nakrmíš usera", permission: "All" },
      { name: "/check", description: "Skontroluj niekomu plienku", permission: "All" },
      { name: "/change", description: "Vymeň niekomu plienku", permission: "All" },
    ],
  },
  minihry: {
    icon: "🎮",
